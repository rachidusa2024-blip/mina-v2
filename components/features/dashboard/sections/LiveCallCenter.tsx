  ...
  return (
    <section className="flex flex-col gap-5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          ...
          <div className="rounded-xl p-4 flex flex-col gap-3"
            ...
            <div className="flex flex-col gap-1">
              <span className="text-xs font-semibold uppercase tracking-wide"
                style={{ fontFamily: "'DM Sans', sans-serif", color: "rgba(239,68,68,0.7)" }}>Caller</span>
              <div className="px-3 py-2 rounded-lg text-sm"
                style={{ fontFamily: "'DM Sans', sans-serif", background: "rgba(239,68,68,0.07)", border: "1px solid rgba(239,68,68,0.15)", color: "var(--text-prime)" }}>
                "We need payment today."
              </div>
            </div>
            <div className="flex flex-col gap-1">
              <span className="text-xs font-semibold uppercase tracking-wide"
                style={{ fontFamily: "'DM Sans', sans-serif", color: "var(--teal)" }}>Mina</span>
              <div className="px-3 py-2 rounded-lg text-sm"
        ...
        {/* RIGHT — Call Through Mina — flagship */}
        <motion.div
          initial={{ opacity: 0, x: 20 }}
          whileInView={{ opacity: 1, x: 0 }}
          viewport={{ once: true }}
          ...
          style={{
            background: "linear-gradient(135deg, #0D1120 0%, #0F1420 50%, rgba(201,168,76,0.06) 100%)",
            border: "1px solid rgba(201,168,76,0.38)",
            boxShadow: "0 0 60px rgba(201,168,76,0.07), 0 20px 50px rgba(0,0,0,0.4)",
          }}>
            ...
            <div className="flex items-start justify-between gap-3">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm mt-1"
                    style={{ fontFamily: "'DM Sans', sans-serif", color: "var(--text-muted)" }}>
                    Mina listens, understands, and protects you.
                  </p>
                </div>
              </div>
            ...
            <div className="rounded-xl p-4 flex flex-col gap-4"
              ...
              <div className="flex items-center gap-2 pb-3"
                ...
                <span className="text-xs font-semibold"
                  style={{ fontFamily: "'DM Sans', sans-serif", color: "rgba(239,68,68,0.8)" }}>
                  Incoming Call
                </span>
              ...
              <div className="flex items-center gap-3">
                <span className="text-xs" style={{ fontFamily: "'DM Sans', sans-serif", color: "rgba(201,168,76,0.5)" }}>Live</span>
                <CallWaveform />
              </div>
              ...
              <div className="flex flex-col gap-2.5">
                {[
                  { who: "Collector", text: '"Payment is due today or legal action will begin."', color: "rgba(239,68,68,0.75)" },
                  { who: "Mina", text: "Pause. Ask for written verification before discussing payment.", color: "#C9A84C", isMina: true },
                ].map(line => (
                  <div key={line.who} className="flex flex-col gap-1">
                    <span className="text-xs font-semibold uppercase tracking-wide"
                    ...
                    <p className={`text-sm px-3 py-2 rounded-lg`}
                      style={{
                        ...
                        background: line.isMina ? "rgba(201,168,76,0.08)" : "rgba(239,68,68,0.06)",
                        border: `1px solid ${line.isMina ? "rgba(201,168,76,0.2)" : "rgba(239,68,68,0.12)"}`,
                      }}>
                      {line.text}
                    </p>
                  </div>
